...
?>
<html>
    <script src="http://localhost/MapTestCase/javascript/jQuery-Google-Map/jquery.googlemap.js" type="text/javascript"></script>
</head>
<body>
...
<div class="container-fluid text-center">    
  <div class="row content">
        ...
        <div class="col-sm-2 sidenav">
            <ul class="nav nav-list" id="GglSidebar" style="min-width: 150px;">
        </ul>
        </div>
