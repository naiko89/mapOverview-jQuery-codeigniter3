...
<div class="container-fluid text-center">    
    <div class="row content">
            ...
            <ul class="nav nav-list" id="LfSidebar" style="min-width: 150px;">
            </ul>
            </div>
...
$.gestPanelLf = function(options){    
        var gP={options : $.extend({
                    ...
                    polyline: ''},options),
                index : function (){ 
                    gP.options.thisMap=L.map('map',{zoomControl: false,zoomDelta: 0.25}).setView([45.665661, 12.245400], 14);
                ...
                printGeocoding : function (geocodObj)
                {
                    ...
                    gP.options.thisMap.setView([geocodObj.hits[0].point.lat, geocodObj.hits[0].point.lng], 14);
